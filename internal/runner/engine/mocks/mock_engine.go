...
// Source: github.com/flowexec/flow/v2/internal/runner/engine (interfaces: Engine)
//
// Generated by this command:
//
//	mockgen -destination=mocks/mock_engine.go -package=mocks github.com/flowexec/flow/v2/internal/runner/engine Engine
//
