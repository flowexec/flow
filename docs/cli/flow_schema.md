---
title: flow schema
description: "Validate flowfiles and workspace configs against their schemas."
---
...
- [flow schema validate](flow_schema_validate.md) — Validate flow files and workspace configs against their schemas.
